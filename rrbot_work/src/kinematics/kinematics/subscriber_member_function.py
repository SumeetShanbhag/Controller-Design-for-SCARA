...
class minimal_subscriber(Node):                               #Create Subscriber Class, inheriting from Node Class  
    ...
    def chatter_callback(self, msg):
        ...
        str1 = "\t|\t"+str(round(x11,2)) + "\t" + str(round(x12,2)) + "\t" + str(round(x13,2)) + "\t" + str(round(x14,2))+"\t|\n"
        str2 = "\t|\t"+str(round(x21,2)) + "\t" + str(round(x22,2)) + "\t" + str(round(x23,2)) + "\t" + str(round(x24,2))+"\t|\n"
        str3 = "\t|\t"+str(round(x31,2)) + "\t" + str(round(x32,2)) + "\t" + str(round(x33,2)) + "\t" + str(round(x34,2))+"\t|\n"
        str4 = "\t|\t"+str(round(x41,2)) + "\t" + str(round(x42,2)) + "\t" + str(round(x43,2)) + "\t" + str(round(x44,2))+"\t|\n"
